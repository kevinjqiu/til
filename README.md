### [Arch Install Notes](t/ARCH_INSTALL_NOTES.md)

* [Download archlinux iso](t/ARCH_INSTALL_NOTES.md#download-archlinux-iso)
* [Write bootable disk](t/ARCH_INSTALL_NOTES.md#write-bootable-disk)
* [Change BIOS to UEFI priority](t/ARCH_INSTALL_NOTES.md#change-bios-to-uefi-priority)
* [Install according to the arch install guide](t/ARCH_INSTALL_NOTES.md#install-according-to-the-arch-install-guide)
* [Install boot loader (systemd-boot)](t/ARCH_INSTALL_NOTES.md#install-boot-loader-systemd-boot)
* [Dhcp service not started](t/ARCH_INSTALL_NOTES.md#dhcp-service-not-started)
* [Install graphics drivers](t/ARCH_INSTALL_NOTES.md#install-graphics-drivers)
...
* [curl LCP Locally](t/work/platform.md#curl-lcp-locally)
  ...
  * [curl with `lcp_curl`](t/work/platform.md#curl-with-lcp-curl)
